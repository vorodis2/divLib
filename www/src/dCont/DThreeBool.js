...
export  function DThreeBool(dCont, _x, _y, fun){
    DCont.call(this);
...
DThreeBool.prototype = Object.create(DCont.prototype);
DThreeBool.prototype.constructor = DThreeBool;
Object.defineProperties(DThreeBool.prototype, {
    height: {
        set : function(value){
